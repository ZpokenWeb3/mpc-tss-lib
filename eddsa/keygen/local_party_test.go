...
// 				assert.Equal(t, pk.X, sk.Public().X, "pkX should match expected pk derived from u")
// 				assert.Equal(t, pk.Y, sk.Public().Y, "pkY should match expected pk derived from u")
