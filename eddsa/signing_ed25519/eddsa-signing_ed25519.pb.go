...
// 	protoc        v3.12.4
// source: eddsa-signing_ed25519.proto
...
func (x *SignRound1Message) Reset() {
	*x = SignRound1Message{}
	mi := &file_eddsa_signing_ed25519_proto_msgTypes[0]
...
func (*SignRound1Message) Descriptor() ([]byte, []int) {
	return file_eddsa_signing_ed25519_proto_rawDescGZIP(), []int{0}
}
...
func (x *SignRound2Message) Reset() {
	*x = SignRound2Message{}
	mi := &file_eddsa_signing_ed25519_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignRound2Message) Descriptor() ([]byte, []int) {
	return file_eddsa_signing_ed25519_proto_rawDescGZIP(), []int{1}
}
...
func (x *SignRound3Message) Reset() {
	*x = SignRound3Message{}
	mi := &file_eddsa_signing_ed25519_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignRound3Message) Descriptor() ([]byte, []int) {
	return file_eddsa_signing_ed25519_proto_rawDescGZIP(), []int{2}
}
...
var File_eddsa_signing_ed25519_proto protoreflect.FileDescriptor

var file_eddsa_signing_ed25519_proto_rawDesc = string([]byte{
	0x0a, 0x1b, 0x65, 0x64, 0x64, 0x73, 0x61, 0x2d, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x5f,
	0x65, 0x64, 0x32, 0x35, 0x35, 0x31, 0x39, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1c, 0x62,
	0x69, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x2e, 0x74, 0x73, 0x73, 0x6c, 0x69, 0x62, 0x2e, 0x65, 0x64,
	0x64, 0x73, 0x61, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x22, 0x33, 0x0a, 0x11, 0x53,
	...
	0x17, 0x5a, 0x15, 0x65, 0x64, 0x64, 0x73, 0x61, 0x2f, 0x73, 0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67,
	0x5f, 0x65, 0x64, 0x32, 0x35, 0x35, 0x31, 0x39, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_eddsa_signing_ed25519_proto_rawDescOnce sync.Once
	file_eddsa_signing_ed25519_proto_rawDescData []byte
)

func file_eddsa_signing_ed25519_proto_rawDescGZIP() []byte {
	file_eddsa_signing_ed25519_proto_rawDescOnce.Do(func() {
		file_eddsa_signing_ed25519_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eddsa_signing_ed25519_proto_rawDesc), len(file_eddsa_signing_ed25519_proto_rawDesc)))
	})
	return file_eddsa_signing_ed25519_proto_rawDescData
}

var file_eddsa_signing_ed25519_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_eddsa_signing_ed25519_proto_goTypes = []any{
...
var file_eddsa_signing_ed25519_proto_depIdxs = []int32{
...
func init() { file_eddsa_signing_ed25519_proto_init() }
func file_eddsa_signing_ed25519_proto_init() {
	if File_eddsa_signing_ed25519_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eddsa_signing_ed25519_proto_rawDesc), len(file_eddsa_signing_ed25519_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_eddsa_signing_ed25519_proto_goTypes,
		DependencyIndexes: file_eddsa_signing_ed25519_proto_depIdxs,
		MessageInfos:      file_eddsa_signing_ed25519_proto_msgTypes,
	}.Build()
	File_eddsa_signing_ed25519_proto = out.File
	file_eddsa_signing_ed25519_proto_goTypes = nil
	file_eddsa_signing_ed25519_proto_depIdxs = nil
}
